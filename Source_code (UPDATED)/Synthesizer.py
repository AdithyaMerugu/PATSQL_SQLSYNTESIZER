...
user_input = ('SELECT', (Table(table_name), None, columns))

# Check the user input
option, (input_table, output_table, select_list) = user_input
if option == 'SELECT':
    # Generate the SQL query
    sql_query = generate_sql_query(input_table, output_table, ('SELECT', select_list))
    print(sql_query)
